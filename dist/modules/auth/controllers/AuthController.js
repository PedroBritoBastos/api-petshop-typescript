...
var AuthController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, AuthController.authService.login(email, password)];
                    case 2:
                        result = _b.sent();
    ...
    AuthController.logout = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, res.status(200).json({ message: "Logout realizado." })];
            });
        });
    };
    // pega o token dos cookies e retorna o payload com os dados do cliente logado
    AuthController.getLoggedClient = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token, payload;
            return __generator(this, function (_a) {
                ...
                payload = JwtProvider.verifyToken(token);
                return [2 /*return*/, res.status(200).json({
                        id: payload.id,
                        email: payload.email,
                        role: payload.role,
    ...
    AuthController.authService = new AuthService(new ClientRepository());
